...
//        andThat(anna).wasAbleTo(UpdateUserProfile.theAssignedLocation().withTheValueOf("2100371205").fromTheClientGroup("300"));
//        andThat(anna).wasAbleTo(UpdateUserLocations.byRemovingTheLocation().withTheValueOf("2100441305"));
        andThat(anna).wasAbleTo(UpdateUserReports.byAddingTheReportsOf(ReportGroup.STANDARD_NONPARTNER_REPORTS));
