...
public class AddLocations implements Task {

    private UserLocationRule locationRule;
    private String value;
    private String clg;

    public AddLocations(UserLocationRule locationRule, String clg, String value) {
        this.locationRule = locationRule;
        this.clg = clg;
        this.value = value;
    }

    public static AddLocations withTheValueOf(UserLocationRule locationRule, String clg, String value) {
        return Instrumented.instanceOf(AddLocations.class).withProperties(locationRule, clg, value);
    }
