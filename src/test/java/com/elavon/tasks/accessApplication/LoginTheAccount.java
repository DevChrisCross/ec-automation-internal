...
public class LoginTheAccount implements Task {

    private final String username;
    private final String password;

    public static LoginTheAccount as(UserType userType) {
        return Instrumented.instanceOf(LoginTheAccount.class).withProperties(userType);
    }
    
    public LoginTheAccount(UserType user) {
